<script>
    ...
    export default {
        ...
        ready: function () {
            let vm = this;
            api.getTopstories(this).then(function (response) {
...
<template>
    <div :class="{ wrap: !items.length }" >
        <div :class="{ loader: !items.length }" ></div>
        <div :class="{ loaderbefore: !items.length }" ></div>
        <div :class="{ circular: !items.length }"  ></div>
        <div :class="{ circular: !items.length }" ></div>
        <div :class="{ text: !items.length }" ></div>
    </div>
    <div class="news-view" :class="{ loading: !items.length }">
        <news-item v-for="item in items" :item="item">loading</news-item>
    </div>
</template>
<style>
    .wrap {
